...
//989741/435693/2.49/3/3/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "FDV303N" (originalName "FDV303N")
	...
	(compDef "FDV303N" (originalName "FDV303N") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FDV303N"))
		...
		(attr "Manufacturer_Part_Number" "FDV303N")
		(attr "Mouser Part Number" "512-FDV303N")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ON-Semiconductor-Fairchild/FDV303N/?qs=FOlmdCx%252BAA1IyXspysHTkA%3D%3D")
		(attr "Arrow Part Number" "FDV303N")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/fdv303n/on-semiconductor")
		(attr "Description" "FDV303N N-Channel MOSFET, 680 mA, 25 V, 3-Pin SOT-23 ON Semiconductor")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/FDV303N-D.PDF")
		(attr "<Component Height>" "1.11")
		(attr "<STEP Filename>" "FDV303N.stp")
