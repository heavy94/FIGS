...
(library Library_1
	...
	(symbolDef "TLV1117-33CDCY" (originalName "TLV1117-33CDCY")
	...
	(compDef "TLV1117-33CDCY" (originalName "TLV1117-33CDCY") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "ADJ/GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "OUTPUT_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "INPUT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "OUTPUT_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV1117-33CDCY"))
		...
		(attr "Manufacturer_Part_Number" "TLV1117-33CDCY")
		(attr "Mouser Part Number" "595-TLV1117-33CDCY")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV1117-33CDCY?qs=p6lVfQR1GSrArgD96KIXHQ%3D%3D")
		(attr "Arrow Part Number" "TLV1117-33CDCY")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tlv1117-33cdcy/texas-instruments")
		(attr "Description" "Single Output LDO, 800mA, Fixed and Adj., Internal Current limit, Thermal Overload Protection")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tlv1117-33.pdf")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "TLV1117-33CDCY.stp")
