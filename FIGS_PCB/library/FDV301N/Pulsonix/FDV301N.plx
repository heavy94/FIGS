...
//167254/435693/2.49/3/3/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "FDV301N" (originalName "FDV301N")
	...
	(compDef "FDV301N" (originalName "FDV301N") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FDV301N"))
		...
		(attr "Manufacturer_Part_Number" "FDV301N")
		(attr "Mouser Part Number" "512-FDV301N")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ON-Semiconductor-Fairchild/FDV301N?qs=HK%252BeIG1iaahv7gPT5tsFJQ%3D%3D")
		(attr "Arrow Part Number" "FDV301N")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/fdv301n/on-semiconductor")
		(attr "Description" "MOSFET N-Channel 25V 0.5A SOT23 Fairchild FDV301N N-channel MOSFET Transistor, 0.22 A, 25 V, 3-Pin SOT-23")
		(attr "<Hyperlink>" "http://docs-emea.rs-online.com/webdocs/00ae/0900766b800ae8f8.pdf")
		(attr "<Component Height>" "1.11")
		(attr "<STEP Filename>" "FDV301N.stp")
